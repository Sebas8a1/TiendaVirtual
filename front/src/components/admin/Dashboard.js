                                ...
                                <div className="col-xl-12 col-sm-12 mb-3">
                                    <div className="card text-white bg-primary o-hidden h-100">
                                        <div className="card-body">
                                            <div className="text-center card-font-size">Total sales<br /> <b>${cantidadTotal && cantidadTotal.toFixed(2)}</b>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row pr-4">
                                <div className="col-xl-3 col-sm-6 mb-3">
                                    <div className="card text-white bg-secondary o-hidden h-100">
                                        ...
                                        <Link className="card-footer text-white clearfix small z-1" to="/admin/productList">
